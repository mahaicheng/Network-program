...
static void square_prog_1(struct svc_req *rqstp, register SVCXPRT *transp) {
  union {
...
int main(int argc, char **argv) {
  ...
  if (!svc_register(transp, SQUARE_PROG, SQUARE_VERS, square_prog_1,
                    IPPROTO_UDP)) {
    fprintf(stderr, "%s",
  ...
  if (!svc_register(transp, SQUARE_PROG, SQUARE_VERS, square_prog_1,
                    IPPROTO_TCP)) {
    fprintf(stderr, "%s",
            "unable to register (SQUARE_PROG, SQUARE_VERS, tcp).");
    exit(1);
  }
